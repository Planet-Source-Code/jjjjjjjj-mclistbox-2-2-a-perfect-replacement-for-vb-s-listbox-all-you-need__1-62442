...
Begin VB.UserControl McListBox 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   147
   ToolboxBitmap   =   "McListBox.ctx":0000
End
...
Private Const m_def_FocusRectangle = True
...
Dim TmpBorderCol As Long
    ...
    For X = xStart To xMax
        ...
        mText = TxtData(0)
        If Not TxtData(1) = -1 And m_ShowIcon Then Set mIcon = m_ImageList.ListImages(Val(TxtData(1)))
        ...
        ' Draw Icon
        If Not TxtData(1) = -1 And m_ShowIcon Then DrawPicture mIcon, 2, mTop + 2, mRowHeight - 4, mRowHeight - 4
